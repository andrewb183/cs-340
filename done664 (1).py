...
class AnimalShelter(object):
    ...
    def init (self, username="andy", password="x"):
        # Initializing the MongoClient. This helps to 
        # access the MongoDB databases and collections. 
        if username and password:
            self.client = MongoClient('mongodb://1822978_snhu@msnv-snhu3-l003:52925',(username, password))
        else:
            self.client = MongoClient('mongodb://1822978_snhu@msnv-snhu3-l003:52925')
